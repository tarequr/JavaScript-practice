...
normalPerson.chargeBill.call(heroPerson, 900, 100, 40);
normalPerson.chargeBill.call(heroPerson, 900, 30, 20);
console.log("Hero Person present salary: " + heroPerson.salary);

normalPerson.chargeBill.call(friendlyPerson, 900, 100, 40);
normalPerson.chargeBill.call(friendlyPerson, 900, 30, 20);
